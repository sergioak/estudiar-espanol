...
- **联想记忆**：记忆：结合词形与释义 '告别' 理解记忆。

## ✏️ 核心用法

**固定表达**：Despido = 告别，辞退，解雇。
- 整体使用，不拆分理解。常见于口语和书面语。

## 📝 例句

1. Los despidos siempre son duros. 离别总是
2. Me echó una mirada despectiva. 他给了我
3. No desperdicies esta comida. 你不要浪费
...
**7.** 翻译：*"DESPIDO ESTAMOS EN BUEN CAMINO."*：
- A) 尽管我们在正确的道路上
- B) 我们在正确的道路上
- C) 我们不得不走这条路
- D) 我们选择了这条路
...
**8.** 介词选择：Se utiliza *"Despido"* seguido de：
- A) 名词/代词
- B) 动词原形
- C) 从句（que）
- D) 视具体情况
...
**9.** 匹配：*Despido* 与哪个汉语释义对应？
- A) 告别
- B) 取消
- C) 隐藏
- D) 拒绝

**答案：A** | 解析：*Despido* 的核心含义是"告别"。

**10.** 造句：用 *"Despido"* 造一个正确的句子：
- A) Despido la situación es difícil.
- B) A pesar de Despido, seguimos adelante.
- C) El problema Despido no tiene solución.
- D) Despido al final del día, descansamos.

**答案：B** | 解析：固定表达需保持整体结构完整，Despido 引导让步/原因状语。
