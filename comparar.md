...
- **联想记忆**：记忆：结合词形与释义 '把……与……做对比' 理解记忆。

## ✏️ 核心用法

**固定表达**：Comparar = 把……与……做对比。
...
**7.** 翻译：*"COMPARAR ESTAMOS EN BUEN CAMINO."*：
- A) 尽管我们在正确的道路上
- B) 我们在正确的道路上
- C) 我们不得不走这条路
- D) 我们选择了这条路
...
**8.** 介词选择：Se utiliza *"Comparar"* seguido de：
- A) 名词/代词
- B) 动词原形
- C) 从句（que）
- D) 视具体情况
...
**9.** 匹配：*Comparar* 与哪个汉语释义对应？
- A) 把……与……做对比
- B) 取消
- C) 隐藏
- D) 拒绝

**答案：A** | 解析：*Comparar* 的核心含义是"把……与……做对比"。

**10.** 造句：用 *"Comparar"* 造一个正确的句子：
- A) Comparar la situación es difícil.
- B) A pesar de Comparar, seguimos adelante.
- C) El problema Comparar no tiene solución.
- D) Comparar al final del día, descansamos.

**答案：B** | 解析：固定表达需保持整体结构完整，Comparar 引导让步/原因状语。
